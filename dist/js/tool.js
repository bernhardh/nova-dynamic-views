...
Nova.booting(function (Vue, router, store) {
  Vue.component('custom-attach-header', __webpack_require__(3));
  Vue.component('custom-create-header', __webpack_require__(6));
  Vue.component('custom-dashboard-header', __webpack_require__(9));
  Vue.component('custom-detail-header', __webpack_require__(12));
  Vue.component('custom-detail-toolbar', __webpack_require__(15));
  Vue.component('custom-index-header', __webpack_require__(18));
  Vue.component('custom-index-toolbar', __webpack_require__(21));
